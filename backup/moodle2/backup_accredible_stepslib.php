...
class backup_accredible_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $accredible = new backup_nested_element('accredible', array('id'), array(
            'name', 'course', 'achievementid', 'description', 'finalquiz', 'passinggrade', 'completionactivities', 'includegradeattribute', 'gradeattributegradeitemid', 'gradeattributekeyname', 'groupid'));
